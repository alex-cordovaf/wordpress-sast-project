...
<footer id="colophon" class="site-footer" itemscope itemtype="https://schema.org/WPFooter">
  <div class="footer-overlay">
    ...
    $green_store_newsletter = best_shop_get_setting( 'subscription_shortcode' );

    if ( $active_sidebars && $sidebar_count > 0 || $green_store_newsletter !== '' ) {
      ?>
    <div class="footer-top">
      <div class="container">
        <?php

        if ( $green_store_newsletter ) {
          ?>
        <div class="footer-newsletter-section">
          <?php
          the_widget( 'best_shop_newsletter_widget', array( 'newsletter_shortcode' => $green_store_newsletter ) );
          ?>
        </div>
        <?php
